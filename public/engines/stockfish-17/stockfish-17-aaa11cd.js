...
!(function () {
    ...
    function e(e) {
      ...
      if (s) {
        (a = o ? require("path").dirname(a) + "/" : __dirname + "/"),
          ...
          (B = function (e, t) {
            return (
              U(), (e = L.normalize(e)), n.readFileSync(e, t ? void 0 : "utf8")
            );
          }),
      ...
      function k(e) {
        for (; 0 < e.length; ) {
          ...
          "function" == typeof n
            ? n(c)
            : "number" == typeof (t = n.Va)
              ? void 0 === n.ga
                ? be(t)()
                : be(t)(n.ga)
              : t(void 0 === n.ga ? null : n.ga);
        }
      }
      function ye(e) {
        var t = ct();
      ...
      var E = {
        ...
        Ya: function () {},
        Fa: function () {
          (E.receiveObjectTransfer = E.Ia),
            (E.threadInit = E.ya),
            (E.setExitStatus = E.Ka),
            (z = !1);
        },
        ba: {},
        Ka: function () {},
        sa: function () {
          for (var e in E.ba) {
            var t = E.ba[e];
            t && t.worker && E.xa(t.worker);
          }
          for (e = 0; e < E.da.length; ++e) E.da[e].terminate();
          E.da = [];
        },
        xa: function (e) {
          E.Ja(function () {
        ...
        Ia: function () {},
        ya: function () {
          for (var e in E.na) E.na.hasOwnProperty(e) && E.na[e]();
        },
        Ga: function (r, a) {
          (r.onmessage = (e) => {
            var t,
                    ...
                    : "cleanupThread" === n
                      ...
                      : "killThread" === n
                        ? ((e = e.thread),
                          ...
                          n.worker.terminate(),
                          ot(e),
                          E.ia.splice(E.ia.indexOf(n.worker), 1),
                          (n.worker.ea = void 0))
                        : "cancelThread" === n
                          ? E.ba[e.thread].worker.postMessage({ cmd: "cancel" })
                          : "loaded" === n
                            ? ((r.loaded = !0),
                              a && a(r),
                              r.ha && (r.ha(), delete r.ha))
                            : "print" === n
        ...
        za: function () {
          ...
          E.da.push(new Worker(e));
        },
        Ca: function () {
          return 0 == E.da.length && (E.za(), E.Ga(E.da[0])), E.da.pop();
        },
      };
      function ve(e) {
        if (d) return I(1, 0, e);
      ...
      function be(e) {
        var t = D[e];
        return (
          t || (e >= D.length && (D.length = e + 1), (D[e] = t = se.get(e))), t
        );
      }
      function xe(e) {
        var t = E.Ca();
        if (!t) return 6;
        E.ia.push(t);
        var n = (E.ba[e.ra] = { worker: t, ta: e.ra }),
          r =
            ((t.ea = n),
            {
              cmd: "run",
              start_routine: e.La,
              arg: e.ga,
              threadInfoStruct: e.ra,
            });
        return (
          (t.ha = () => {
            (r.time = performance.now()), t.postMessage(r, e.Qa);
          }),
          t.loaded && (t.ha(), delete t.ha),
          0
        );
      }
            ...
            !u.wa && u.Sa
              ...
              : ((e = !1),
                (u = u.wa ? u.wa : u).la &&
                  u.la.ka &&
                  (e =
                    0 === (e = u.la.ka.getParameter(2978))[0] &&
                    0 === e[1] &&
                    e[2] === u.width &&
                    e[3] === u.height),
                (u.width = t),
                (u.height = n),
                e && u.la.ka.viewport(0, 0, t, n),
                0))
          : -4;
      }
      function je(e, t, n) {
      ...
      function qe(n, e) {
        n.ua ||
          ...
          (n.getContext = function (e, t) {
            return ("webgl" == e) ==
              (t = n.ua(e, t)) instanceof WebGLRenderingContext
              ? t
              : null;
          }));
        var t,
          ...
          o = n.getContext("webgl", e);
        {
          if (o) {
            if (
              ...
              (r = ut(8)),
              (h()[(r + 4) >> 2] = it()),
              (a = { Xa: r, attributes: e, version: e.Ha, ka: o }),
              o.canvas && (o.canvas.la = a),
              (void 0 === e.va || e.va) && !(o = (o = a) || Pe).Ea)
            ) {
              o.Ea = !0;
              var i = (t = o.ka),
                u = i.getExtension("ANGLE_instanced_arrays"),
                s =
                  (u &&
                    ((i.vertexAttribDivisor = function (e, t) {
                      u.vertexAttribDivisorANGLE(e, t);
                    }),
                    (i.drawArraysInstanced = function (e, t, n, r) {
                      u.drawArraysInstancedANGLE(e, t, n, r);
                    }),
                    (i.drawElementsInstanced = function (e, t, n, r, a) {
                      u.drawElementsInstancedANGLE(e, t, n, r, a);
                    })),
                  t),
                c = s.getExtension("OES_vertex_array_object"),
                f =
                  (c &&
                    ((s.createVertexArray = function () {
                      return c.createVertexArrayOES();
                    }),
                    (s.deleteVertexArray = function (e) {
                      c.deleteVertexArrayOES(e);
                    }),
                    (s.bindVertexArray = function (e) {
                      c.bindVertexArrayOES(e);
                    }),
                    (s.isVertexArray = function (e) {
              ...
              l &&
                ...
                (t.Ta = t.getExtension("EXT_disjoint_timer_query")),
                (t.$a = t.getExtension("WEBGL_multi_draw")),
      ...
      function Ne(e, t, n, r) {
        return d
          ? I(10, 1, e, t, n, r)
          : ((e = Ae.Wa(e)), (t = Ae.Ua(e, t, n)), (h()[r >> 2] = t), 0);
      }
      ...
      function Xe(e, t, n, r) {
        ...
        function s(e) {
          e = C(new Date(e.aa + 1900, 0, 1), e.qa);
        ...
        var l,
          ...
          f = {
            "%a": function (e) {
              return p[e.pa].substring(0, 3);
            },
            "%A": function (e) {
              return p[e.pa];
            },
            "%b": function (e) {
              return m[e.fa].substring(0, 3);
            },
            "%B": function (e) {
              return m[e.fa];
            },
            "%C": function (e) {
              return o(((e.aa + 1900) / 100) | 0, 2);
            },
            "%d": function (e) {
              return o(e.ja, 2);
            },
            ...
            "%I": function (e) {
              return 0 == (e = e.oa) ? (e = 12) : 12 < e && (e -= 12), o(e, 2);
            },
            "%j": function (e) {
              return o(e.ja + Qe(R(e.aa + 1900) ? O : T, e.fa - 1), 3);
            },
            "%m": function (e) {
              return o(e.fa + 1, 2);
            },
            ...
            "%U": function (e) {
              var t = new Date(e.aa + 1900, 0, 1),
                n = 0 === t.getDay() ? t : C(t, 7 - t.getDay());
              return i(n, (e = new Date(e.aa + 1900, e.fa, e.ja))) < 0
                ? o(
                    Math.ceil(
                      (31 -
                        n.getDate() +
                        (Qe(R(e.getFullYear()) ? O : T, e.getMonth() - 1) -
                          31) +
                        e.getDate()) /
                        7
                    ),
            ...
            "%V": function (e) {
              var t = new Date(e.aa + 1901, 0, 4),
                n = u(new Date(e.aa + 1900, 0, 4)),
                t = u(t),
                r = C(new Date(e.aa + 1900, 0, 1), e.qa);
              return i(r, n) < 0
                ? "53"
                : i(t, r) <= 0
                  ? "01"
            ...
            "%W": function (e) {
              var t = new Date(e.aa, 0, 1),
                n =
                  1 === t.getDay()
                    ? t
                    : C(t, 0 === t.getDay() ? 1 : 7 - t.getDay() + 1);
              return i(n, (e = new Date(e.aa + 1900, e.fa, e.ja))) < 0
                ? o(
                    Math.ceil(
                      (31 -
            ...
            "%y": function (e) {
              return (e.aa + 1900).toString().substring(2);
            },
            "%Y": function (e) {
              return e.aa + 1900;
            },
        ...
        return (
          ...
          (d = Array(oe(l) + 1)),
          w(l, d, 0, d.length),
          (c = d).length > t ? 0 : (ue(c, e), c.length - 1)
        );
      }
      E.Da();
      var ze,
        Je = [null, ve, ke, Ee, De, Ie, je, Ue, Ye, He, Ne, Ve, Ge],
        Ke = {
          p: function (e, t) {
            Ze(e, t);
          },
            ...
            return "undefined" == typeof SharedArrayBuffer
              ...
              : ((a = []),
                d && 0 === a.length
                  ...
                  : ((e = { La: n, ra: e, ga: r, Qa: a }),
                    d
                      ? ((e.Ra = "spawnThread"), postMessage(e, a), 0)
                      : xe(e)));
          },
          g: ke,
          w: Ee,
          ...
          D: function (e, t, n) {
            ...
            return (e < 0 ? ge[-e - 1] : Je[e]).apply(null, Re);
          },
          A: function (e) {
            var t = l().length;
        ...
        Ze =
          (!(function () {
            ...
            if (
              (d ||
                (S++, c.monitorRunDependencies && c.monitorRunDependencies(S)),
              c.instantiateWasm)
            )
              try {
          ...
          (c.___wasm_call_ctors = function () {
            return (c.___wasm_call_ctors = c.asm.E).apply(null, arguments);
          }),
          (c._main = function () {
            return (Ze = c._main = c.asm.F).apply(null, arguments);
          })),
        $e =
          ((c._command = function () {
            return (c._command = c.asm.G).apply(null, arguments);
          }),
          (c._isReady = function () {
            return (c._isReady = c.asm.H).apply(null, arguments);
          }),
          (c._free = function () {
            return (c._free = c.asm.I).apply(null, arguments);
          }),
          (c._emscripten_tls_init = function () {
            return (c._emscripten_tls_init = c.asm.J).apply(null, arguments);
          }),
          (c.___errno_location = function () {
            return ($e = c.___errno_location = c.asm.K).apply(null, arguments);
          })),
        et =
          ((c.__emscripten_thread_crashed = function () {
            return (c.__emscripten_thread_crashed = c.asm.L).apply(
              null,
              arguments
            );
          }),
          (c._emscripten_proxy_main = function () {
            return (c._emscripten_proxy_main = c.asm.M).apply(null, arguments);
          }),
          (c.__emscripten_thread_init = function () {
            return (et = c.__emscripten_thread_init = c.asm.N).apply(
              null,
              arguments
            );
          })),
        ...
        it =
          ((c.__emscripten_thread_exit = function () {
            return (c.__emscripten_thread_exit = c.asm.U).apply(
              null,
              arguments
            );
          }),
          (c._pthread_self = function () {
            return (it = c._pthread_self = c.asm.V).apply(null, arguments);
          })),
        ut = (c._malloc = function () {
          return (ut = c._malloc = c.asm.W).apply(null, arguments);
        }),
        st = (c._emscripten_stack_set_limits = function () {
          return (st = c._emscripten_stack_set_limits = c.asm.Y).apply(
            null,
            arguments
          );
        }),
        ...
        ft = (c.stackRestore = function () {
          return (ft = c.stackRestore = c.asm._).apply(null, arguments);
        }),
        j = (c.stackAlloc = function () {
          return (j = c.stackAlloc = c.asm.$).apply(null, arguments);
        }),
        lt = (c.__emscripten_allow_main_runtime_queued_calls = 78432256);
      function q(e) {
      ...
      function pt(e) {
        ...
        b() || d || E.sa(),
          b() || (E.sa(), c.onExit && c.onExit(e), (K = !0)),
          r(e, new q(e));
      }
      if (
  ...
  function t(n) {
    var e,
      r = 0,
      a = [],
      t = u.slice(1 + ((u.lastIndexOf(".") - 1) >>> 0)),
      o = u.slice(0, -t.length);
    for (e = 0; e < n; ++e)
      !(function (e, t) {
        fetch(new Request(e))
          .then(function (e) {
        ...
        (function (t) {
          return function (e) {
            ++r,
              (a[t] = e),
              r === n && ((e = URL.createObjectURL(new Blob(a))), s(e));
          };
        })(e)
      );
  }
      ...
      ? ((e =
        ...
        e
          ? require.main === module
            ? ((c = require("path")),
              ...
              require("readline")
                ...
                .on("line", function (e) {
                  e &&
                    (n.sendCommand ? n.sendCommand(e) : r.push(e),
          ...
          : ((e = self.location.hash.substr(1).split(",")),
            ...
            "number" == typeof enginePartsCount ? t(enginePartsCount) : s(),
            (onmessage =
              onmessage ||
              function (e) {
                if (
                  (n.sendCommand ? n.sendCommand(e.data) : r.push(e.data),
