    ...
    <>
      ...
      <Container maxWidth="md" sx={{ py: 6 }}>
        ...
        <Typography variant="body1" paragraph>
          Checkmate Tracker is a free web application designed to help chess players of all levels analyze their games, play against Stockfish, and store their most important matches.
        </Typography>
